...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-N8Q82NX');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N8Q82NX"
    ...
    <section class="font-sans container m-auto flex px-5">
        ...
        <div class="flex-1 flex items-start flex-col justify-center">
            ...
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-32 lg:pr-16 md:px-32 lg:px-0" action="https://startuptrader.us10.list-manage.com/subscribe/post?u=b5dd78240963f0c36286af015&amp;id=c23e574cd9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate>
                ...
                <input type="hidden" name="b_b5dd78240963f0c36286af015_c23e574cd9" tabindex="-1" value="">
    ...
    <section class="text-center pt-32 pb-40 bg-pink-500 relative">
        ...
        <div class="container mx-auto text-center px-5">
            ...
            <form class="block sm:flex w-full px-0 sm:px-16 xl:pr-6 lg:pr-16 md:px-32 lg:px-0 lg:w-1/2 lg:m-auto lg:mt-8" action="https://startuptrader.us10.list-manage.com/subscribe/post?u=b5dd78240963f0c36286af015&amp;id=c23e574cd9" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate>
